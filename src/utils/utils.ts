...
export function getBlockchainNetwork(chainId: number): NetworkConfig {
    switch (chainId) {
        case CHAIN_ID_AVAX_TESTNET: return {
        ...
        case CHAIN_ID_MATIC_TESTNET: return {
        ...
        case CHAIN_ID_AVAX_MAINNET: return {
        ...
        case CHAIN_ID_MATIC_MAINNET: return {
        ...
        default: throw new Error('Given blockchain Id is not yet supported')
    }
}
